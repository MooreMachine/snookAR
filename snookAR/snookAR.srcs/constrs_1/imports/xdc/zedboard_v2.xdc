#buttons
set_property PACKAGE_PIN N15 [get_ports button_debounce]
#leds
set_property PACKAGE_PIN T22 [get_ports led_config_finished]
set_property IOSTANDARD LVCMOS33 [get_ports led_config_finished]

#set_property PACKAGE_PIN T21 [get_ports {pclk_led}]
#set_property IOSTANDARD LVCMOS33 [get_ports {pclk_led}]
# VGA out
# "VGA-B1"
...
# JA0
set_property PACKAGE_PIN V12 [get_ports {ov7670_pwdn[0]}]
...
# JA1
set_property PACKAGE_PIN W10 [get_ports {ov7670_data[0]}]
...
# JA2
set_property PACKAGE_PIN V9 [get_ports {ov7670_data[2]}]
...
# JA3
set_property PACKAGE_PIN V8 [get_ports {ov7670_data[4]}]
...
# JB4
set_property PACKAGE_PIN Y11 [get_ports {ov7670_data[7]}]
...
# JB5
set_property PACKAGE_PIN AA11 [get_ports ov7670_pclk]
...
# JB6
set_property PACKAGE_PIN Y10 [get_ports ov7670_vsync]
...
#iic_0_scl_io
set_property PACKAGE_PIN AA9 [get_ports ov7670_sioc]
...
create_clock -period 40.000 -name clk_fpga_25 -waveform {0.000 20.000} -add [get_nets -hierarchical *processing_system7_0_FCLK_CLK2*]
