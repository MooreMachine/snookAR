...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.Read_Width_A {15} \
   CONFIG.Read_Width_B {15} \
   CONFIG.Register_PortA_Output_of_Memory_Primitives {false} \
   CONFIG.Register_PortB_Output_of_Memory_Primitives {false} \
   CONFIG.Use_Byte_Write_Enable {false} \
   CONFIG.Use_RSTA_Pin {false} \
   CONFIG.Write_Depth_A {307200} \
   CONFIG.Write_Width_A {15} \
   CONFIG.Write_Width_B {15} \
  ...
  connect_bd_intf_net -intf_net axi_periph_M04_AXI [get_bd_intf_pins axi_periph/M04_AXI] [get_bd_intf_pins color_detector_0/S00_AXI]
  connect_bd_intf_net -intf_net axi_periph_M05_AXI [get_bd_intf_pins axi_periph/M05_AXI] [get_bd_intf_pins balls_overlay_0/S00_AXI]
  ...
  connect_bd_net -net M01_ACLK_0_1 [get_bd_ports ov7670_pclk] [get_bd_pins axi_periph/M01_ACLK] [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins fifo_s2mm/s_aclk] [get_bd_pins ov7670_decode_stream_0/pclk] [get_bd_pins ov7670_decode_stream_0/s00_axi_aclk] [get_bd_pins rst_ov7670_pclk/slowest_sync_clk]
  ...
  connect_bd_net -net balls_overlay_0_hsync_out [get_bd_ports vga_hsync] [get_bd_pins balls_overlay_0/hsync_out]
  connect_bd_net -net balls_overlay_0_vga_b_out [get_bd_ports vga_b] [get_bd_pins balls_overlay_0/vga_b_out]
  connect_bd_net -net balls_overlay_0_vga_g_out [get_bd_ports vga_g] [get_bd_pins balls_overlay_0/vga_g_out]
  connect_bd_net -net balls_overlay_0_vga_r_out [get_bd_ports vga_r] [get_bd_pins balls_overlay_0/vga_r_out]
  connect_bd_net -net balls_overlay_0_vsync_out [get_bd_ports vga_vsync] [get_bd_pins balls_overlay_0/vsync_out]
  connect_bd_net -net blk_mem_gen_0_doutb [get_bd_pins blk_mem_gen_0/doutb] [get_bd_pins color_detector_0/bram_data]
  connect_bd_net -net color_detector_0_bram_addr [get_bd_pins blk_mem_gen_0/addrb] [get_bd_pins color_detector_0/bram_addr]
  ...
  connect_bd_net -net ov7670_decode_stream_0_bram_addr [get_bd_pins blk_mem_gen_0/addra] [get_bd_pins ov7670_decode_stream_0/bram_addr]
  connect_bd_net -net ov7670_decode_stream_0_bram_data [get_bd_pins blk_mem_gen_0/dina] [get_bd_pins ov7670_decode_stream_0/bram_data]
  connect_bd_net -net ov7670_decode_stream_0_bram_we [get_bd_pins blk_mem_gen_0/wea] [get_bd_pins ov7670_decode_stream_0/bram_we]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins debounce_0/clk] [get_bd_pins ov7670_controller_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK2 [get_bd_pins balls_overlay_0/clk25] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins fifo_mm2s/m_aclk] [get_bd_pins rst_vga_clk25/slowest_sync_clk] [get_bd_pins stream_to_vga_0/clk25]
  ...
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins axi_periph/M00_ARESETN] [get_bd_pins axi_periph/M02_ARESETN] [get_bd_pins axi_periph/M03_ARESETN] [get_bd_pins axi_periph/M04_ARESETN] [get_bd_pins axi_periph/M05_ARESETN] [get_bd_pins axi_periph/S00_ARESETN] [get_bd_pins balls_overlay_0/s00_axi_aresetn] [get_bd_pins color_detector_0/s00_axi_aresetn] [get_bd_pins fifo_mm2s/s_aresetn] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn] [get_bd_pins vdma_mm2s/axi_resetn] [get_bd_pins vdma_mm2s_intercon/M00_ARESETN] [get_bd_pins vdma_mm2s_intercon/S00_ARESETN] [get_bd_pins vdma_s2mm/axi_resetn] [get_bd_pins vdma_s2mm_intercon/M00_ARESETN] [get_bd_pins vdma_s2mm_intercon/S00_ARESETN]
  connect_bd_net -net stream_to_vga_0_blue [get_bd_pins balls_overlay_0/vga_b_in] [get_bd_pins stream_to_vga_0/blue]
  connect_bd_net -net stream_to_vga_0_fsync [get_bd_pins stream_to_vga_0/fsync] [get_bd_pins vdma_mm2s/mm2s_fsync]
  connect_bd_net -net stream_to_vga_0_green [get_bd_pins balls_overlay_0/vga_g_in] [get_bd_pins stream_to_vga_0/green]
  connect_bd_net -net stream_to_vga_0_hcounter [get_bd_pins balls_overlay_0/hcounter] [get_bd_pins stream_to_vga_0/hcounter]
  connect_bd_net -net stream_to_vga_0_hsync [get_bd_pins balls_overlay_0/hsync_in] [get_bd_pins stream_to_vga_0/hsync]
  connect_bd_net -net stream_to_vga_0_red [get_bd_pins balls_overlay_0/vga_r_in] [get_bd_pins stream_to_vga_0/red]
  connect_bd_net -net stream_to_vga_0_vcounter [get_bd_pins balls_overlay_0/vcounter] [get_bd_pins stream_to_vga_0/vcounter]
  connect_bd_net -net stream_to_vga_0_vsync [get_bd_pins balls_overlay_0/vsync_in] [get_bd_pins stream_to_vga_0/vsync]
  connect_bd_net -net vsync_1 [get_bd_ports ov7670_vsync] [get_bd_pins ov7670_decode_stream_0/vsync]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs balls_overlay_0/S00_AXI/S00_AXI_reg] SEG_balls_overlay_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs color_detector_0/S00_AXI/S00_AXI_reg] SEG_color_detector_0_S00_AXI_reg
